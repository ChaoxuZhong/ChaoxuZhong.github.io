...
```yml
# Site settings
title: Chaoxu Blog             # title of your website
SEOTitle: Chaoxu Blog          # check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“Chaoxu Blog”** but I want the title shows in search engine is **“黄玄的博客 | Chaoxu Blog”** which is multi-language.
